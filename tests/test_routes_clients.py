...
def test_create_client(mock_publish):
    payload = {"name": "Test Client", "email": "test@example.com", "company": "TestCorp", "phone": "+330000000", "is_active": True}
...
def test_update_client(mock_publish):
    payload = {"name": "Old Name", "email": "update@example.com", "company": "OldCorp", "phone": "+33123456789", "is_active": True}
    create_resp = client.post("/clients/", json=payload, headers=get_auth_headers())
    client_id = create_resp.json()["_id"]

    updated = {"name": "New Name", "email": "update@example.com", "company": "NewCorp", "phone": "+33999999999", "is_active": False}
...
def test_delete_client(mock_publish):
